...
export function ExcelImportSection() {
  ...
  return (
    <div>
      <PageHeader
        title="Excel aktarım"
        description="LİSTE başlıkları (KODU, GRUP, HAMMADDE, ROTA…): sistem bu sütun adlarıyla okur; tüm sütunlar aktarım kaydında saklanır. Formüller, Excel’in kaydettiği hesaplanmış değer olarak okunur. İkinci sayfada isteğe bağlı ham madde kartları."
        breadcrumbs={[
